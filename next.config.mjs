...
const nextConfig = {
  images: {
    ...
    // Disable optimization as fallback for problematic external images
    unoptimized: false, // Set to true if you continue having issues
    // Add custom loader timeout (in milliseconds)
    loader: "default",
